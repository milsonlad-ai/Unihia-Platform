      ...
      >
        <div className="text-center space-y-6">
          ...
          <div className="space-y-2">
            <h1 className="text-4xl font-bold text-white tracking-tighter leading-none">Crie sua conta</h1>
            <p className="text-zinc-500 text-sm font-medium">Inicie sua jornada na Unihia Platform.</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <div className="relative group">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 text-zinc-600 group-focus-within:text-unihia-accent transition-colors" size={18} />
              <input 
                type="text" 
                required
                value={name}
        ...
        <p className="text-center text-zinc-500 text-xs font-medium">
          Já tem uma conta? <Link to="/login" className="text-unihia-accent hover:underline">Entre agora</Link>
        </p>
      </motion.div>
    </div>
  );
